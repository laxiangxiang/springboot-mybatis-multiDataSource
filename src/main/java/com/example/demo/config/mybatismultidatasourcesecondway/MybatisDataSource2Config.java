 ...
 */
@Configuration
@MapperScan(basePackages = "com.example.demo.mapper.datasourcetwo",sqlSessionTemplateRef = "test2SqlSessionTemplate")
public class MybatisDataSource2Config {
    ...
    public SqlSessionFactory testSqlSessionFactory(@Qualifier("test2DataSource")DataSource dataSource) throws Exception{
        ...
        bean.setMapperLocations(new PathMatchingResourcePatternResolver().getResources("classpath:mapper/datasourcetwo/*.xml"));
